...
Item {
    ...
    ColumnLayout {
        ...
        StyledCard {
            ...
            StyledDivider {
                visible: TextInjectorClient.isDevBuild || !TextInjectorClient.isKde
            }
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            StyledButton {
                                ...
                                size: "small"
                                onClicked: {
                                    DictationPadModel.copyTextToClipboard("qtranscribe --toggle");
                                }
                            }
                        }
                    }
