...
T.Dialog {
    ...
    contentItem: T.ScrollView {
        ...
        ColumnLayout {
            ...
            StyledText {
                text: qsTr(
                          "QTranscribe uses clipboard paste injection simulating Ctrl+Shift+V to insert transcribed speech directly into your active applications on Wayland.")
                variant: "body"
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        StyledIcon {
                            source: "qrc:/qt/qml/QTranscribe/assets/icons/copy.svg"
                            color: Theme.accentColor
                            size: 18
                            Layout.alignment: Qt.AlignTop
                        }
